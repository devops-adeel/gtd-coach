...
case "$COMMAND" in
    ...
    timing)
        ...
        echo "================================="
        echo ""
        docker compose run --rm gtd-coach python3 -m pytest tests/test_integrations.py::test_timing
        ;;
    ...
    test-trace-linking)
        ...
        echo "======================================="
        echo ""
        docker compose run --rm gtd-coach python3 -m pytest tests/test_integrations.py::test_langfuse_trace_linking
        ;;
    ...
    analyze-timing)
        ...
        echo "=========================================="
        echo ""
        docker compose run --rm gtd-coach python3 scripts/analyze_timing.py
        ;;
